...
# 4x4 Square - Averages
python simulation.py -st RANDOM -he 4 -w 4 -sh RECTANGLE -n 10000 -d 0 > rect4_4_rand_avg.txt
python simulation.py -st STAIRCASE -he 4 -w 4 -sh RECTANGLE -n 10000 -d 0 > rect4_4_stair_avg.txt
