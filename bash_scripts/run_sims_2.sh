...
python simulation.py -st RANDOM -r 2 -sh CIRCLE -n 1000 -d 0 > circ_2_rand_avg.txt
python simulation.py -st STAIRCASE -r 2 -sh CIRCLE -n 1000 -d 0 > circ_2_stair_avg.txt
python simulation.py -st SPIRL -r 2 -sh CIRCLE -n 1000 -d 0 > circ_2_spiral_avg.txt
